...
int main()
{
	char name[30], pizza1[]="Chicken Dominator" ,pizza2[]="Chicken Barbecue" ,pizza3[]="Chicken Peri Peri" ,pizza4[]="Creamy Max", roll1[]="Chicken Chatni Roll", roll2[]="Chicken Mayo Roll", roll3[]="Veg Roll With Fries",bur1[]="Zinger Burger",bur2[]="Chicken Burger",bur3[]="Veg Burger";
	char sand1[]="Club Sandwich", sand2[]="Chicken Crispy Sandwich", sand3[]="Extream Veg Sandwich";
	char bir1[]="Chicken Biryani", bir2[]="Prawn Biryani", bir3[]="Mutton Biryani",gotostart ;
	int choice=0,pchoice,pchoice1, quantity;// time=40;
	beginning:
	system("CLS");
	cout<<"\t\t\t------PRO Snaks & Fast Food------\n\n";
	...
	if(choice==1)
	 {
		...
		if(pchoice>=1 && pchoice<=5)
		{
			...
			switch (pchoice1)
			{
			 ...
			 cout<<"\n\nThank you For Ordering From PRO Snacks & Fast Food\n";
			 break;
			 case 2:
			 cout<<"\t\t--------Your Order---------\n";
